...
function upload($image_info){
  $cloud = new ServiceBuilder([
    'keyFilePath' => __DIR__ .'/codex-site-komantnick-5264d6f5074b.json',
...
else{header("Location: $image_path");}
}


/*}
//use Google\Cloud\Storage\StorageClient;
//putenv('GOOGLE_APPLICATION_CREDENTIALS=D:/xampp/htdocs/codex/codex-site-komantnick-5264d6f5074b.json');
// Authenticate to Google Cloud Services using a keyfile path


/*$bucket = $storage->createBucket('codex-storage-by-komantnick');
